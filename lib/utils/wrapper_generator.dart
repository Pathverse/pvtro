...
String generateOutputFile(List<SlangPackageInfo> packages) {
  ...
  buffer.writeln();
  buffer.writeln('// ignore_for_file: no_leading_underscores_for_library_prefixes, depend_on_referenced_packages, library_prefixes');
  buffer.writeln();
  ...
  buffer.writeln();
  buffer.write(generateLocaleSync(packages));
